'use strict';
// BotCom Workbench UI dictionary. Consumed by i18n.js.
window.BOTCOM_DICT = {
  // ---------- 侧栏 ----------
  ...
  // ---------- 欢迎页（首次引导，按文本片段拆分）----------
  '欢迎使用 BotCom Workbench': 'Welcome to BotCom Workbench',
  'AI 运营工作台——管理文件、指挥 agent、审核内容、跟踪发布，都在一个窗口：': 'The vibe-coding cockpit — find files, run agents, watch them edit, edit on the fly, all in one window:',
