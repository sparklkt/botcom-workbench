 ...
 * 渲染进程通过 window.botcomPty 控制 node-pty，window.botcomEnv 判断是否在桌面 app 内。
 */
const { contextBridge, ipcRenderer, webUtils } = require('electron');

contextBridge.exposeInMainWorld('botcomPty', {
...
contextBridge.exposeInMainWorld('botcomFs', {
...
contextBridge.exposeInMainWorld('botcomWin', {
  focus: () => ipcRenderer.invoke('win:focus'), // 点通知拉回前台
});

contextBridge.exposeInMainWorld('botcomEnv', {
  isDesktopApp: true,
